...
accessscatter %>%  #KEEPING
  ...
  geom_point() + 
  labs(x = "Percentage of the population acessing the Internet", y = "logarithm of GDP per capita", title = "How acess to the internet affects economic output") +
...
priceaccessscatter %>% 
  ...
  ggplot(data = priceaccessscatter, mapping = aes(x = as.numeric(priceyear_values), y = accessyear_values, colour = Continental.region)) +
  geom_point() + 
  labs(x = "Price of Internet", y = "Percentage of the population acessing the Internet", title = "How price of internet affects acess to the internet") +
  geom_smooth(method="lm", col="black")  +
  theme(plot.title=element_text(size=30))
...
AgreeDisagreePie <- function(percent, my_title) {
  ...
  ggplot(data, aes(x="", y=amount, fill=category)) +
    ...
    theme(plot.title = element_text(size=15),
          ...
          plot.margin = margin(0, 0.7, 0, 1.5, "cm"))
}
...
pricespeedcatter %>% 
  ...
  geom_point() + 
  labs(x = "Price of Internet", y = "GDP per capita", title = "How price of internet changes with speed of internet available") +
  geom_smooth(method="lm", col="black")  +
