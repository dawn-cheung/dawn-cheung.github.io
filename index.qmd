...
-   speed of internet (the widget uses download speed which, simply put, is how fast you can receive information from the web).

You might be wondering: "Why go beyond access to the internet? As long as the resource is physically available, isn't that enough?"
